...
<%--                <input type="hidden" id="id" name="id">--%>
    ...
    <div class="container">
        ...
        <hr>
        <table class="table table-striped" id="tableMeal">
            <thead>
            <tr>
            ...
            <c:forEach items="${meals}" var="meal">
                ...
                <tr data-mealExcess="${meal.excess}">
                    ...
                    <td>${meal.calories}</td>
                    <td><a><span class="fa fa-pencil" onclick="update('${meal.id}', '${meal.dateTime}', '${meal.description}', '${meal.calories}')"></span></a></td>
