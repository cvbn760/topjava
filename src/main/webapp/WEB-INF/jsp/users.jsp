...
<script type="text/css" src="resources/css/style.css" defer></script>
    ...
    <div class="container">
        ...
        <table class="table table-striped" id="datatable">
            ...
            <c:forEach items="${users}" var="user">
                ...
                <tr data-userCheck="${user.enabled}">
                    <td><c:out value="${user.name}"/></td>
                    <td><a href="mailto:${user.email}">${user.email}</a></td>
                    <td>${user.roles}</td>
                    <td><input type="checkbox" onclick="checkUser($(this), ${user.id})" <c:if test="${user.enabled}">checked</c:if>/></td>
