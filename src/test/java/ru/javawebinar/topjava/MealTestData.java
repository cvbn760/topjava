...
import ru.javawebinar.topjava.web.user.TestMatcher;
...
public class MealTestData {
    ...
    public static final Meal ADMIN_MEAL1 = new Meal(ADMIN_MEAL_ID, of(2020, Month.JANUARY, 30, 11, 0), "Админ ланч", 510);
    public static final Meal ADMIN_MEAL2 = new Meal(ADMIN_MEAL_ID + 1, of(2020, Month.JANUARY, 30, 20, 0), "Админ ужин", 1500);
